...
+ [[id:6902c5a0-e96d-4b02-89b9-e45036e5d3fd][Org SQL]]
+ [[id:73bf4813-c8a7-472b-aeaa-b0ddceb44cc9][Org Hugo]]
+ [[id:2530678f-bb04-4187-8a47-3e461a6092d4][Org Static Blog]]
+ [[id:ee8d8d5b-776c-493a-846c-fe4a80a37ef3][Org Tables]]
+ [[id:92e78219-c00f-407c-91e6-1fae065806e5][Org on Android]]
...
Org-mode, like virtually all of [[id:754f25a5-3429-4504-8a17-4efea1568eba][Emacs]], is self-documenting. A useful file to read is ~ORG-NEWS~ but where to find it? It
is likely on your system under ~/usr/share/emacs/xx.y/etc/ORG-NEWS~ but if you update to bleeding edge from ELPA/MELPA
then you can find it under ~./config/emacs/elpa/org-x.yy.zz/etc/ORG-NEWS~ to find out what has changed under the hood.
...
+ [[https://www.youtube.com/watch?v=SzA2YODtgK4][Getting Started With Org Mode - YouTube]] - great video on doing lots of stuff.
...
+ [[https://flandrew.srht.site/listful/every-emoji-in-one-hash-table-playing-with-emacs-ucs-names.html][Every emoji in one hash table: playing with Emacs' ucs‑names — Listful Andrew]]
