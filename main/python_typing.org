...
:mtime:    20251218144923 20251201155537 20251130190331 20250919201148 20250318092039 20250106221721 20241204135030 20231222190513 20231128102157
...
[[http://mypy-lang.org/][mypy]] is a static type checker.
...
[[https://docs.astral.sh/ty][ty]] is a Python typer analyse written in Rust from the authors of ruff. It is /very/ fast.


* Zuban

[[id:68a8963f-a5b2-4f76-be1a-a379ebb791be][Zuban]] is another static typer for Python written in rust, it is also /very/ fast. Unlike ~ty~ it aims to be compliant
with ~mypy~.
...
+ [[https://martynassubonis.substack.com/p/advanced-overlooked-python-typing][Advanced, Overlooked Python Typing - by Martynas Šubonis]]
