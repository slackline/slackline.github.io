...
This is a universal ebook reader which is available for [[https://github.com/koreader/koreader/wiki/Installation-on-Kobo-devices][installation on Kobo devices]]. I've not yet tried this out as I
just don't have enough free time to do so.

One neat thing though is that you can convert [[https://github.com/srijan/emacs-v4/blob/main/config.org#51-koreader-json-to-org][KOReader JSON to Org]].
