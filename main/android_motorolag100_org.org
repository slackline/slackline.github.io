...
:mtime:    20251231081707 20251227211325 20251227184524 20251227141324 20250305071008 20250304222343 20241021192025 20241020132011
...
2. Whilst waiting download the corresponding ~boot.img~ to your phone from the LineageOS [[https://download.lineageos.org/devices/nio/builds][download]] page.
3. Install the new LineageOS image from the updater.
4. Once installed reboot, you will have lost ~root~
4. Start Magisk and follow the [[https://topjohnwu.github.io/Magisk/install.html][instructions]] to the letter to patch the ~boot.img~, copy back to your computer and flash
...
+ I often rename [[id:80b19a83-2f8c-4442-a55c-6708c7dab921][magisk]] to hide it, I opt for the default app which reverses the spelling, i.e. "Ksigam".
+ I found on one occasion that I had reinstall Magisk before I could patch the boot image and before the newly flashed
  boot image showed as rooted within Magisk I had to uninstall "Ksigam" (apps still detected root so it had worked).



* Upgrading

Major versions of [[id:86e356e8-931f-40f7-9393-13a89c22c00d][lineageos]] require a fresh image to be flashed. [[https://lineageos.org/Changelog-30/][Changelog 30 - LineageOS Blog]] (2025-10-11) announced an
upgrade to LineageOS 23 but it wasn't until 2025-12-10 that an image appeared for the g100 (nio). Upgrading sounds
daunting but isn't that bad, if you already have LineageOS installed you've gone through this procedure once. Things to
note...
...
[[id:80b19a83-2f8c-4442-a55c-6708c7dab921][Magisk]] is the /de facto/ goto for rooting your device, at least in my experience of +10yrs of rooting Android devices,
...
it. It is no longer available via GitHub but I have a copy lying around on my computer.

* Slots

Motorola devices have two "slots" for flashing boot images to (a and b) which means you can choose what kernel to boot
from. You can toggle which is active from "bootloader" (aka "fastboot") mode using
...
+ [[https://download.lineageos.org/devices/nio/builds][LineageOS Downloads]]
