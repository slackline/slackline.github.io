...
I use Quarto for a [[https://blog.nshephard.dev/][blog]].

** Custom Navbar icons

*** ORCID

Found a useful [[https://rmflight.github.io/posts/2022-12-03-using-academicons-in-your-quarto-blog/][article]] on adding custom ORCID icons.
...
** [[https://github.com/coatless-quarto/toggle][toggle]]

Hide code blocks in Quarto HTML documents. You can toggle individual output if ~output-sync: false~ is set.
...
** [[https://github.com/davidwyld/openlinksinnewpage][openlinksinnewpage]]

Causes all links to open in a new page.
...
+ [[https://qmd4sci.njtierney.com/][Quarto for Scientists]]
...
+ [[https://github.com/gadenbuie/countdown][gadenbuie/countdown: ⏲ countdown timer for slides and HTML docs in Quarto, R Markdown, and Shiny]]
...
+ [[https://nrennie.rbind.io/blog/collaborating-quarto/][Collaborating on Quarto documents – Nicola Rennie]]
