...
:mtime:    20251122142315 20251103115120 20251016113248 20230103103312 20220301215133
...
The above example includes ~npt.NDArray[np.float64]~ but this only works because of the configuration option
~ConfigDict(arbitrary_types_allowed=True)~ normally Pydantic will complain about these. Fortunately there are efforts to
include arrays in Pydantic.
...
[[https://numpydantic.readthedocs.io/en/latest/index.html][numpydantic]] is a more general package that works with any array implementation and is easier to extend.


* Links

+ [[https://pydantic-docs.helpmanual.io/][pydantic]]
+ [[https://github.com/caniko/pydantic-numpy][pydantic-numpy]]
+ [[https://numpydantic.readthedocs.io/en/latest/index.html][numpydantic]]
...
+ [[https://www.bitecode.dev/p/pydantic-can-do-what?publication_id=1516188&post_id=179635958&triedRedirect=true][Pydantic can do what? - Bite code!]]
