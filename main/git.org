...
A useful article/tutorial on [[https://gist.github.com/ThomasFrans/ab1cb531410ab0cd0616a88a735dd840][A gentle introduction to Git worktree]] which is useful when working with large projects and
you want to have multiple branches checked out simultaneously. It helps avoid the need to ~git stash~ before switching
branches.
