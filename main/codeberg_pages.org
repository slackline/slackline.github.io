...
The ForgeJo Action [[https://codeberg.org/git-pages/action#with-a-custom-domain][git-pages/action]] provides a simple way of uploading statically generated sites to [[https://codeberg.org/git-pages/git-pages][git-pages]].

* Configuration

[[id:284615e5-516f-4b04-a3d8-2a5ea9480f8e][Codeberg Woodpecker CI]]  needs to be able to push to your repository in order to publish the pages. To do this you need to add a
...
+ [[https://codeberg.org/git-pages/git-pages][git-pages/git-pages: Scalable static site server for Git forges - Codeberg.org]]
+ [[https://codeberg.org/git-pages/git-pages-cli][git-pages/git-pages-cli: Command-line tool for publishing a site to a git-pages server - Codeberg.org]]
+ [[https://codeberg.org/git-pages/action#with-a-custom-domain][git-pages/action: Forgejo Action for uploading a directory to a git-pages site - Codeberg.org]]
...
+ [[https://aartaka.me/codeberg-pages.html][Codeberg Pages with SSL and Custom Domain]]
+ [[https://aartaka.me/codeberg-pages-2.html][Codeberg Pages 2: Setting Up Subdomain for git-pages Back-end]]

** Misc

+ [[https://wwwobble.org/][wwwobble.org]] - drag and drop to create websites that can be exported to Codeberg Pages
