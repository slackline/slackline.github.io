...
+ [[https://codeberg.org/gedankenstuecke/git-pages-woodpecker-plugin][gedankenstuecke/git-pages-woodpecker-plugin - Codeberg.org]] submit output of a CI pipeline to a ~git-pages~ deployment
