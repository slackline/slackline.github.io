...
:mtime:    20260918173322 20240705080904
...
Symlink ~/etc/init.d/<service>.<user_name>~ to ~/etc/init.d/<service>~ and add the service

#+begin_example
ln -s /etc/init.d/<service>.<user_name> /etc/init.d/<service>
#+end_example
