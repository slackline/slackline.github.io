...
directory with using ~M-: (byte-recompile-directory package-user-dir nil 'force)~ which will [[https://stackoverflow.com/a/1217249][force compilation]]. (I
actually found ~M: (byte-recompile-directory "~/.config/emacs/elpa/" 0 t)~ to be more effective)
