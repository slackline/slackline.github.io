...
:mtime:    20251227184515 20251120133916 20251107143616 20250513083634 20240919222900 20231008074712 20230910194920 20230910183127
:ctime:    20230910183127
:END:
#+TITLE: Pre-commit
#+FILETAGS: :git:hooks:pre-commit:

[[https://pre-commit.com/][Pre-commit]] is a powerful [[id:3c905838-8de4-4bb6-9171-98c1332456be][Git]] tool for executing a range of hooks prior to making commits to your Git history. This is
...
+ [[https://worktree.ca/taffer/todo-linter][taffer/todo-linter]] : Ensure to-do items in your code have an owner and an issue. - todo-linter
...
+ [[https://github.com/cleder/gpc-init][cleder/gpc-init: Initialize a prek/pre-commit yaml with recommended checks]] - "ai" augmented

** Critique

+ [[https://jyn.dev/pre-commit-hooks-are-fundamentally-broken/][pre-commit hooks are fundamentally broken]]
