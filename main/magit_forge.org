...
I found I could push and pull a [[id:ddcfed69-2ba5-442a-99b4-eaa5c7a9fe40][Git Worktrees]] from Magit but the status buffer always showed there was no upstream and I
couldn't create pull-requests. I asked on the [[https://github.com/magit/forge/discussions/849][Forge discussions]] and the amazing @tarsius (Jonas Bernoulli) worked out
that I was missing a ~fetch~ under ~remote "origin"~ section of my configuration.

#+begin_example
[remote "origin"]
    url = git@github.com:<organisation>/repo.git
	fetch = +refs/heads/*:refs/remotes/origin/*    # This was missing from my config
