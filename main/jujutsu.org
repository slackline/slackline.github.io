...
:mtime:    20251130164059 20251005224009 20250831233426 20250814151048 20250608183502 20250608152257 20250323151929 20250313085514 20250302204650 20250209181233 20250204230408 20250109123853 20250106104827 20250104211131 20241229195347 20241224191824 20241223211940 20241223113355 20241223083247 20241221221347 20241221211157 20241221201119 20241221163742 20241221152122 20241221072719 20241211112128 20240630205259 20240204192058
...
In Git this can be done either by adding a ~git commit --fixup~ or using ~git rebase -i~ to interactively squash
...
has stated they have deprioritized development in light of the later, see [[https://www.reddit.com/r/emacs/comments/1hbmpub/comment/m1inz3i/][here]]). More recently [[https://github.com/0WD0/majutsu][majutsu]] has appeared on
my radar claiming to be "/Majutsu! [[id:220d7ba9-d30e-4149-a25b-03796e098b0d][Magit]] for jujutsu/" so I'll be exploring that.
...
which is one of the best [[id:754f25a5-3429-4504-8a17-4efea1568eba][Emacs]] packages going (that may not be an issue given [[https://github.com/0WD0/majutsu][majutsu]] "/Magit for Jujutsu/" ).
...
+ [[https://steveklabnik.github.io/jujutsu-tutorial/introduction/introduction.html][Steve's Jujutsu Tutorial]] - assumes working knowledge of [[id:3c905838-8de4-4bb6-9171-98c1332456be][Git]].
+ [[https://jj-for-everyone.github.io/][Jujutsu for everyone]] - doesn't assume working knowledge of [[id:3c905838-8de4-4bb6-9171-98c1332456be][Git]].
+ [[https://evmar.github.io/jjtut/][Evan's Jujutsu Tutorial]]

** IDE/Interfaces

*** Terminal

+ [[https://github.com/emilien-jegou/oyui][oyui: Modern TUI merge tool and interactive diff editor for Jujutsu (jj) and Git]]
...
+ [[https://github.com/0WD0/majutsu][majutsu: Majutsu! Magit for jujutsu]]
...
+ [[https://radicle.xyz/2025/08/14/jujutsu-with-radicle][Jujutsu + Radicle = ❤️]]
+ [[https://maddie.wtf/posts/2025-07-21-jujutsu-for-busy-devs][Jujutsu For Busy Devs | maddie, wtf?!]]
+ [[https://www.stavros.io/posts/switch-to-jujutsu-already-a-tutorial/][Switch to Jujutsu already: a tutorial - Stavros' Stuff]]
+ [[https://v5.chriskrycho.com/essays/jj-init/][jj init — Sympolymathesy, by Chris Krycho]]
+ [[https://blog.appliedcomputing.io/p/frustrations-with-version-control][Frustrations with Version Control - by drmorr]]
+ [[https://etodd.io/2025/10/02/should-i-switch-from-git-to-jujutsu/][Should I Switch From Git to Jujutsu · Evan Todd]]
