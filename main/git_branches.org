...
:mtime:    20240804174300 20240217093159 20240130203610
...
+ [[https://andrewlock.net/working-with-stacked-branches-in-git-is-easier-with-update-refs/][Working with stacked
  branches in Git is easier with --update-refs]]
