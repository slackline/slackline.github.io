...
[[https://etckeeper.branchable.com/][etckeeper]] is a tool that uses version control ([[id:3c905838-8de4-4bb6-9171-98c1332456be][Git]] by default) to track changes to the systems ~/etc/~ directory.

** ~sysgit~

[[https://framagit.org/kepon/sysgit][sysgit]] extends the concept of ~etckeeper~ to the whole system.
