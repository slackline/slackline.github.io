...
:mtime:    20260910150040 20240705080642
...
[[https://packages.gentoo.org/][Gentoo Packages]] management under Gentoo is courtesy of [[https://wiki.gentoo.org/wiki/Portage][Portage]] and the ~emerge~ command which resolves all dependencies. It is
...
There is [[https://gitlab.com/akater/emacs-portage][emacs-portage]] which provides a way of running [[id:0998b01c-7d0a-4aec-99ec-908374de338c][Gentoo Portage]] commands from Emacs via [[id:b9961a9e-e833-4160-aa8f-1c69b9cbb397][Emacs TRAMP]] ability to run
commands as ~su~
