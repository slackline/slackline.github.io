...
The [[https://github.com/python-versioneer/python-versioneer/blob/master/INSTALL.md][installation instructions]] are concise and clear and should be easy to follow.
...
Traceback (most recent call last):
  File "/home/user/.virtualenvs/pgfinder/lib/python3.10/site-packages/pep517/in_process/_in_process.py", line 351, in <module>
    main()
  File "/home/user/.virtualenvs/pgfinder/lib/python3.10/site-packages/pep517/in_process/_in_process.py", line 333, in main
    json_out['return_val'] = hook(**hook_input['kwargs'])
  File "/home/user/.virtualenvs/pgfinder/lib/python3.10/site-packages/pep517/in_process/_in_process.py", line 285, in get_requires_for_build_sdist
    return hook(config_settings)
  File "/home/user/.virtualenvs/pgfinder/lib/python3.10/site-packages/setuptools/build_meta.py", line 181, in get_requires_for_build_sdist
    return self._get_build_requires(config_settings, requirements=[])
  File "/home/user/.virtualenvs/pgfinder/lib/python3.10/site-packages/setuptools/build_meta.py", line 159, in _get_build_requires
    self.run_setup()
  File "/home/user/.virtualenvs/pgfinder/lib/python3.10/site-packages/setuptools/build_meta.py", line 174, in run_setup
...
This resulted in an ~AttributeError~
* Links
