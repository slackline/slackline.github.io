...
This is the traditional method of configuring a package, but has been deprecated in favour of ~setup.cfg~ and/or
~pyproject.toml~
...
The new kid on the block ~pyproject.toml~ support is still under development although its already highly functional.
