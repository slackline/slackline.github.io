...
[[https://docs.pypi.org/trusted-publishers/creating-a-project-through-oidc/][Pending Publisher]]. This requires that you have a workflow such as the above in place and that it includes the
...
[[id:378d14b6-3b5b-496a-b70a-fee6a3c64ed3][Hatch]] is a new and popular package for managing Python packages.
