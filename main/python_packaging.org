...
It is also possible to use a "src" based structure where the package directory resides within the ~src~ directory. This
is used in common [[id:14310dd9-647a-4532-9a50-d75becb0d409][templating systems]] such as the [[https://github.com/napari/napari-plugin-template/#napari-plugin-template][napari-plugin-template]] and [[https://github.com/scientific-python/cookie][Scientific Python Cookiecutter]].
...
can be completely empty or they can contain code that is used throughout your package, such as setting up a logger.
...
For more on versioning see [[id:1fe19d13-aa30-48ae-a765-5f96c0b03484][Python Versioning]].
...
+ [[https://blog.yossarian.net/2026/07/07/You-shouldnt-trust-trusted-publishing][You shouldn't trust Trusted Publishing]]
