...
You can check what file is used for a given user with ~tools::makevars_user()~
...
The [[https://withr.r-lib.org][withr]] package has some useful utilities too such as [[https://withr.r-lib.org/reference/set_makevars.html][~withr::set_makevars()~]] to create a new ~Makevars~ file by adding
new variables and [[https://withr.r-lib.org/reference/with_makevars.html][~withr::with_makevars()~]] to temporarily change contents of an existing ~Makevars~ file.
