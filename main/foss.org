...
FOSS software doesn't suffer from [[id:37edd337-e171-4f76-b3f6-f781c304e3f1][enshitification]] quite as badly as private companies but is not immune to the slop of
AI bullshit.


There is also the issue of which [[id:143e393e-ab25-48ea-9aa5-908a68965839][Cloud Services]] we as individuals and our government services/institutions should use.

* Contributions

I make small contributions to projects both as part of my work and outside of my work. I keep a list of my contributions
...
+ [[https://fosdem.org/2026/schedule/event/7YMJST-how-to-lead-change-to-open-source/][FOSDEM 2026 - From Vendor Lock-in to Resilient Digital Ecosystems: Leading Change in Europe's Public Digital
  Infrastructure]]
...
+ [[https://selfhost.directory/][selfhost.directory]]

** Maintenance

+ [[https://ossresistance.com/][OSSResistance]] - repair the FOSS tools you use at work on company time.
...
+ [[https://about.code.europa.eu/][code.europa.eu - Code development platform]]

** Essays

+ [[https://www.arscyni.cc/file/take_my_money.html][What if I paid for all my free software? | Angelino Desmet]]
+ [[https://blog.khinsen.net/posts/2026/07/06/conviviality.html][Conviviality in computational science]]
+ [[https://qspace.fqxi.org/competitions/entry/2310][Towards Convivial Science]]
...
+ [[https://disjunctionsmag.com/articles/foss-contra-big-tech/][FOSS Contra Big Tech]]
...
+ [[https://fosdem.org/2026/schedule/event/SUVS7G-lets_end_open_source_together_with_this_one_simple_trick/][FOSDEM 2026 - Let's end open source together with this one simple trick]]
+ [[https://malus.sh/][MALUS - Clean Room as a Service | Liberation from Open Source Attribution]]

** Vulneratbilities

+ [[https://akrites.org/][Akrites | Patch the Commons, Together]]
+ [[https://www.half-second.com/][Half a Second - The Backdoor That Almost Broke the Internet, and the Invisible Labor Beneath It]]
