...
+ [[id:fb7ecbc4-9fb1-4a7a-ae7e-293bc0cdfc54][RSQLite]]
...
:mtime:    20251207212325 20231222005051 20231205220407 20231023104105 20231023070045
...
[[https://a2-ai.github.io/rv-docs/][rv]] is a "/declarative package manager/" in the vein of the [[id:5b5d1562-ecb4-4199-b530-e7993723e112][Python]] package manager [[id:99d3e5a1-bf9b-44f3-afc9-fed5ffead7bd][uv]]. Like ~uv~ it is written in [[id:3469c33e-7c61-46c7-b01e-655695f3b93c][Rust]]
and uses the [[id:08b71419-a3fc-4c7e-8fb6-75f613e41315][Just]] scripting/build system for some of the building. I'm yet to use it but have hopes that it will be
better than the ~renv~ experience which I find has many pain points (but that is likely down to me not using R that
often these days).
...
+ [[https://nrennie.rbind.io/blog/gps-route-map-r/][Create custom GPS route maps in R – Nicola Rennie]]
...
+ [[https://flir.etiennebacher.com/][Find and Fix Lints in R Code • flir]] Fix Lints In R and R package that uses Abstract Syntax Trees to parse and fix
  linting errors (think [[id:3070e6ed-1788-44ff-8498-8af6c84f588f][Emacs Tree-Sitter]])
+ [[https://lintr.r-lib.org/][A Linter for R Code • lintr]]
+ [[https://jarl.etiennebacher.com/][Jarl – jarl]] Just Another R Linter written in Rust very fast and corrects errors unlike ~lintr~ and is faster than
  ~flir~ (although its from the same author).
+ [[https://ropensci.org/blog/2026/04/02/tree-sitter-overview/][rOpenSci | A Better R Programming Experience Thanks to Tree-sitter]]
...
+ [[https://r-mailing-lists.thecoatlessprofessor.com/][Home | R Mailing Lists]]
...
+ [[https://github.com/scienceverse/metacheck/][scienceverse/metacheck: Check Research Outputs for Best Practices]]
